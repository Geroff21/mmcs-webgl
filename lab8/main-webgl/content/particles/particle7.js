...
class Particle1 {
    constructor() {
        ...
        this.rotationSpeed = 0.5; // Скорость вращения частиц
    }
...
class SnowParticle {
    ...
    createParticleShape() {
        ...
        this.vertexes = [
            this.position[0], this.position[1] + size, this.position[2],
            this.position[0] + 0.95 * size, this.position[1] + 0.3 * size, this.position[2],
            this.position[0] + 0.58 * size, this.position[1] - 0.8 * size, this.position[2],
            this.position[0] - 0.58 * size, this.position[1] - 0.8 * size, this.position[2],
            this.position[0] - 0.95 * size, this.position[1] + 0.3 * size, this.position[2],
        ];
        this.indices = [
    ...
    update(deltaTime) {
        ...
        const mouseEffectRadius = 2; // Радиус действия мыши
        const mouseEffectStrength = 0.5; // Сила эффекта
